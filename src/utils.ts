...
export const DADOS_INICIAIS_INFORME: InformeMensal = {
  ...
  status: 'Aprovado',
  versao: 1,
  ultimaAtualizacao: '27/08/2026 16:30',
  autorUltimaAtualizacao: '1° Ten PM Froes',
  historico: [
    {
      id: 'hist-1',
      dataHora: '27/08/2026 16:30',
      usuario: '1° Ten PM Froes',
      acao: 'Homologação e Aprovação Oficial',
      detalhe: 'Informe de agosto consolidado com registros fotográficos e layout comparativo Antes e Depois.',
    },
  ],
  ...
  paginas: [
    {
      ...
      detalhes: {
        local: 'Vestiários do Bloco Central - 3ª Cia',
        responsavel: 'Cad PM Cristian / Cb PM Ribeiro',
        dataInicio: '15/08/2026',
        dataTermino: '20/08/2026',
      ...
      fotos: [
        {
          ...
          legenda: 'Chuveiro inoperante com fiação aparente e vazamentos',
          tipoBadge: 'antes',
        ...
        },
        {
          ...
          legenda: 'Chuveiro eletrônico 6800W instalado, dimensionado e vedado',
          tipoBadge: 'depois',
...
export const DADOS_INICIAIS_MEMBROS: import('./types').MembroEquipe[] = [
  ...
  // Policiais Militares em Apoio Oficiais da Seção de Manutenção
  {
    id: 'membro-apoio-lima',
    graduacao: 'Cad PM',
    nomeGuerra: 'Cad PM Lima',
    re: '243255-2',
    especialidade: 'Pintura e Auxiliar Geral',
    telefone: '',
    anoCurso: '2°CFO',
    ...
    ativo: true,
    tipoEfetivo: 'apoio',
    origemApoio: '2°CFO D 3ª Cia',
    impedimentosPorData: {
      '2026-09-16': 'Pintura na Cavalaria / Festa da Espora',
    },
  },
  {
    id: 'membro-apoio-pimenta',
    graduacao: 'Cad PM',
    nomeGuerra: 'Cad PM Pimenta',
    re: '260107-9',
    especialidade: 'Auxiliar Geral',
    telefone: '',
    anoCurso: '1°CFO',
    pelotao: 'A',
    ativo: true,
    tipoEfetivo: 'apoio',
    origemApoio: '1ºCFO A 1ª Cia',
    impedimentosPorData: {
      '2026-09-16': 'Aulas 9/10',
    },
  },
...
export const MISSOES_OFICIAIS_HISTORICAS: import('./types').MissaoDiaria[] = [
  // Quarta-feira, 16 de Setembro de 2026
  {
    id: 'mis-2026-09-16-1',
    data: '2026-09-16',
    titulo: 'Confecção Informe de Setembro',
    descricao: 'Confecção do Informe de Setembro',
    local: 'Sala 2ºD',
    prioridade: 'Média',
    membrosDesignados: 'Cad PM Salvioni',
    turno: 'Tarde (9º e 10º tempos)',
    concluida: false,
    adiadaParaProximoDia: false,
    observacoes: 'Sala de Aula 2ºD',
  },
  // Quinta-feira, 17 de Setembro de 2026
  {
    id: 'mis-2026-09-17-1',
    data: '2026-09-17',
    titulo: 'Monumento 3ªCIA',
    descricao: 'Pintura do monumento',
    local: 'Escada 3ªCIA',
    prioridade: 'Média',
    equipeId: 'eq-3',
    equipeNome: 'Equipe Charlie - Pintura & Auxiliar Geral',
    membrosDesignados: 'Cad PM Salvioni, Cad PM Freire, Cad PM Perozin, Cad PM Lima, Cad PM Pimenta',
    turno: 'Manhã (07h15)',
    concluida: false,
    adiadaParaProximoDia: false,
    materiaisNecessarios: 'Materiais pelo QTH',
    observacoes: 'QSO 06h40 no QTH',
  },
  {
    id: 'mis-2026-09-17-2',
    data: '2026-09-17',
    ...
    equipeId: 'eq-3',
    equipeNome: 'Equipe Charlie - Pintura & Auxiliar Geral',
    membrosDesignados: 'Cad PM Salvioni, Cad PM Freire, Cad PM Isack, Cad PM Perozin, Cad PM Lima, Cad PM Pimenta',
    turno: 'Tarde (9º e 10º tempos)',
    concluida: false,
    adiadaParaProximoDia: false,
    materiaisNecessarios: 'Materiais pelo QTH',
    observacoes: 'QSO 16h30 no QTH',
  },
  {
    id: 'mis-2026-09-17-3',
    data: '2026-09-17',
    titulo: 'Missão Iluminação do Telhado',
    descricao: 'Fixação dos Refletores',
    local: 'Pátio Interno/Rancho',
    prioridade: 'Alta',
    equipeId: 'eq-1',
    equipeNome: 'Equipe Alfa - Elétrica & Gestão',
    membrosDesignados: 'Cad PM Fabio, Cad PM Ulisses Silveira, Cad PM Ravely',
    turno: 'Tarde (9º e 10º tempos)',
    concluida: false,
    adiadaParaProximoDia: false,
    materiaisNecessarios: 'Materiais pelo local',
    observacoes: 'QSO 16h30 no QTH',
  },
];
